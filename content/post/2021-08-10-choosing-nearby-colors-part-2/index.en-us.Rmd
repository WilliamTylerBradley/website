...
author: Tyler
date: '2021-08-10'
slug: nearby_colors_part_2
summary: Follow-up from previous post using the HCL coordinates directly.
thumbnailImage: /post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/hcl_par_per.jpeg
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/c_l_plane.jpeg', error = FALSE)
```
:::
::: {}
```{r color_h_c_plane_image, eval = TRUE, echo = FALSE, fig.cap = "Base Color: H-C Plane"}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/h_c_plane.jpeg', error = FALSE)
```
:::
::::

```{r color_h_l_curve_image, eval = TRUE, echo = FALSE, fig.cap = "Base Color: H-L Curve"}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/h_l_curve.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/c_tangent_plane_setup.jpeg', error = FALSE)
```
:::
::: {}
```{r color_c_tangent_plane_image, eval = TRUE, echo = FALSE, fig.cap = "Base Color: Plane Perpendicular to C-L Plane"}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/c_tangent_plane.jpeg', error = FALSE)
```
:::
::::
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/xyl_info.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/xyl_c_l_plane.jpeg', error = FALSE)
```
:::
::: {}
```{r xyl_c_l, eval = TRUE, echo = FALSE, fig.cap = "xyL: C-L by H cuts"}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/xyl_c_l.jpeg', error = FALSE)
```
:::
::::
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/xyl_h_l_curve.jpeg', error = FALSE)
```
:::
::: {}
```{r xyl_h_l, eval = TRUE, echo = FALSE, fig.cap = "xyL: H-L by C cuts"}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/xyl_h_l.jpeg', error = FALSE)
```
:::
::::
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/xyl_h_c_plane.jpeg', error = FALSE)
```
:::
::: {}
```{r xyl_h_c, eval = TRUE, echo = FALSE, fig.cap = "xyL: H-C by L cuts"}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/xyl_h_c.jpeg', error = FALSE)
```
:::
::::
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/xyl_par_per.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/xyl_per_l.jpeg', error = FALSE)
```
:::
::: {}
```{r xyl_par_l, eval = TRUE, echo = FALSE, fig.cap = "xyL: Parallel Distance-L by Perpendicular Distance cuts"}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/xyl_par_l.jpeg', error = FALSE)
```
:::
::::
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/hcl_info.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/hcl_c_l_plane.jpeg', error = FALSE)
```
:::
::: {}
```{r hcl_c_l, eval = TRUE, echo = FALSE, fig.cap = "HCL: C-L by H cuts"}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/hcl_c_l.jpeg', error = FALSE)
```
:::
::::
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/hcl_h_l_curve.jpeg', error = FALSE)
```
:::
::: {}
```{r hcl_h_l, eval = TRUE, echo = FALSE, fig.cap = "HCL: H-L by C cuts"}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/hcl_h_l.jpeg', error = FALSE)
```
:::
::::
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/hcl_h_c_plane.jpeg', error = FALSE)
```
:::
::: {}
```{r hcl_h_c, eval = TRUE, echo = FALSE, fig.cap = "HCL: H-C by L cuts"}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/hcl_h_c.jpeg', error = FALSE)
```
:::
::::
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/hcl_par_per.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/hcl_per_l.jpeg', error = FALSE)
```
:::
::: {}
```{r hcl_par_l, eval = TRUE, echo = FALSE, fig.cap = "HCL: Parallel Distance-L by Perpendicular Distance cuts"}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/hcl_par_l.jpeg', error = FALSE)
```
:::
::::
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/compare_c_l.jpeg', error = FALSE)
```
:::
::: {}
```{r compare_h_l, eval = TRUE, echo = FALSE, fig.cap = "Comparison: H-L by C cuts"}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/compare_h_l.jpeg', error = FALSE)
```
:::
::::
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/compare_h_c.jpeg', error = FALSE)
```
:::
::: {}
```{r compare_par_per, eval = TRUE, echo = FALSE, fig.cap = "Comparison: Parallel-Perpendicular by L cuts"}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/compare_par_per.jpeg', error = FALSE)
```
:::
::::
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/compare_per_l.jpeg', error = FALSE)
```
:::
::: {}
```{r compare_par_l, eval = TRUE, echo = FALSE, fig.cap = "Comparison: Parallel-L by Perpendicular cuts"}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/compare_par_l.jpeg', error = FALSE)
```
:::
::::
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/compare_samples.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/compare_samples2.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/C_lower_c_l.jpeg', error = FALSE)
```
:::
::: {}
```{r C_lower_h_l, eval = TRUE, echo = FALSE, fig.cap = "Lower C: H-L by C cuts "}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/C_lower_h_l.jpeg', error = FALSE)
```
:::
::::
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/C_lower_h_c.jpeg', error = FALSE)
```
:::
::: {}
```{r C_lower_par_per, eval = TRUE, echo = FALSE, fig.cap = "Lower C: Parallel-Perpendicular by L cuts"}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/C_lower_par_per.jpeg', error = FALSE)
```
:::
::::
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/C_lower_per_l.jpeg', error = FALSE)
```
:::
::: {}
```{r C_lower_par_l, eval = TRUE, echo = FALSE, fig.cap = "Lower C: Parallel-L by Perpendicular cuts"}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/C_lower_par_l.jpeg', error = FALSE)
```
:::
::::
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/C_lower_samples.jpeg', error = FALSE)
```
:::
::: {}
```{r C_lower_samples2, eval = TRUE, echo = FALSE, fig.cap = "Lower C: Samples H by C"}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/C_lower_samples2.jpeg', error = FALSE)
```
:::
::::
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/C_higher_c_l.jpeg', error = FALSE)
```
:::
::: {}
```{r C_higher_h_l, eval = TRUE, echo = FALSE, fig.cap = "Higher C: H-L by C cuts "}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/C_higher_h_l.jpeg', error = FALSE)
```
:::
::::
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/C_higher_h_c.jpeg', error = FALSE)
```
:::
::: {}
```{r C_higher_par_per, eval = TRUE, echo = FALSE, fig.cap = "Higher C: Parallel-Perpendicular by L cuts"}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/C_higher_par_per.jpeg', error = FALSE)
```
:::
::::
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/C_higher_per_l.jpeg', error = FALSE)
```
:::
::: {}
```{r C_higher_par_l, eval = TRUE, echo = FALSE, fig.cap = "Higher C: Parallel-L by Perpendicular cuts"}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/C_higher_par_l.jpeg', error = FALSE)
```
:::
::::
...
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/C_higher_samples.jpeg', error = FALSE)
```
:::
::: {}
```{r C_higher_samples2, eval = TRUE, echo = FALSE, fig.cap = "Higher C: Samples H by C"}
knitr::include_graphics('/post/2021-08-10-choosing-nearby-colors-part-2/index.en-us_files/C_higher_samples2.jpeg', error = FALSE)
```
:::
::::

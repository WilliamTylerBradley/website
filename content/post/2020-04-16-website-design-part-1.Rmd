...
The source code file is found [here](https://github.com/WilliamTylerBradley/site_design/blob/master/scrape_wiki.R){target="_blank"}.  This data will be read back into R to create the images in the [next post](/2020/04/17/website-design-part-2/).
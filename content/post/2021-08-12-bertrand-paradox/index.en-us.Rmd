...
thumbnailImage: /post/2021-08-12-bertrand-paradox/index.en-us_files/thumbnail.png
...
knitr::include_graphics('/post/2021-08-12-bertrand-paradox/index.en-us_files/1_2_info.png', error = FALSE)
```
:::
::: {}
```{r info_3_4, eval = TRUE, echo = FALSE, fig.cap = "Method 2 Colors"}
knitr::include_graphics('/post/2021-08-12-bertrand-paradox/index.en-us_files/3_4_info.png', error = FALSE)
```
:::
::: {}
```{r info_5_6, eval = TRUE, echo = FALSE, fig.cap = "Method 3 Colors"}
knitr::include_graphics('/post/2021-08-12-bertrand-paradox/index.en-us_files/5_6_info.png', error = FALSE)
```
:::
::::
...
knitr::include_graphics('/post/2021-08-12-bertrand-paradox/index.en-us_files/1_c_l.png', error = FALSE)
```
:::
::: {}
```{r cl_3, eval = TRUE, echo = FALSE}
knitr::include_graphics('/post/2021-08-12-bertrand-paradox/index.en-us_files/3_c_l.png', error = FALSE)
```
:::
::: {}
```{r cl_5, eval = TRUE, echo = FALSE}
knitr::include_graphics('/post/2021-08-12-bertrand-paradox/index.en-us_files/5_c_l.png', error = FALSE)
```
:::
::::
:::: {style="display: grid; grid-template-columns: 1fr 1fr 1fr; align-items: center; justify-items: center; grid-column-gap: 1px;"}
...
knitr::include_graphics('/post/2021-08-12-bertrand-paradox/index.en-us_files/2_c_l.png', error = FALSE)
```
:::
::: {}
```{r cl_4, eval = TRUE, echo = FALSE, fig.cap = "Method 2 Chroma-Luminance Plane"}
knitr::include_graphics('/post/2021-08-12-bertrand-paradox/index.en-us_files/4_c_l.png', error = FALSE)
```
:::
::: {}
```{r cl_6, eval = TRUE, echo = FALSE, fig.cap = "Method 3 Chroma-Luminance Plane"}
knitr::include_graphics('/post/2021-08-12-bertrand-paradox/index.en-us_files/6_c_l.png', error = FALSE)
```
:::
::::
...
knitr::include_graphics('/post/2021-08-12-bertrand-paradox/index.en-us_files/1_h_c.png', error = FALSE)
```
:::
::: {}
```{r hc_3, eval = TRUE, echo = FALSE}
knitr::include_graphics('/post/2021-08-12-bertrand-paradox/index.en-us_files/3_h_c.png', error = FALSE)
```
:::
::: {}
```{r hc_5, eval = TRUE, echo = FALSE}
knitr::include_graphics('/post/2021-08-12-bertrand-paradox/index.en-us_files/5_h_c.png', error = FALSE)
```
:::
::::
:::: {style="display: grid; grid-template-columns: 1fr 1fr 1fr; align-items: center; justify-items: center; grid-column-gap: 1px;"}
...
knitr::include_graphics('/post/2021-08-12-bertrand-paradox/index.en-us_files/2_h_c.png', error = FALSE)
```
:::
::: {}
```{r hc_4, eval = TRUE, echo = FALSE, fig.cap = "Method 2 Hue-Chroma Plane"}
knitr::include_graphics('/post/2021-08-12-bertrand-paradox/index.en-us_files/4_h_c.png', error = FALSE)
```
:::
::: {}
```{r hc_6, eval = TRUE, echo = FALSE, fig.cap = "Method 3 Hue-Chroma Plane"}
knitr::include_graphics('/post/2021-08-12-bertrand-paradox/index.en-us_files/6_h_c.png', error = FALSE)
```
:::
::::
...
From here to the end are the final products.

</br>

```{r method_1_image, eval = TRUE, echo = FALSE, fig.cap = "Method 1"}
knitr::include_graphics('/post/2021-08-12-bertrand-paradox/index.en-us_files/method_1.png', error = FALSE)
```
</br>
</br>
```{r method_2_image, eval = TRUE, echo = FALSE, fig.cap = "Method 2"}
knitr::include_graphics('/post/2021-08-12-bertrand-paradox/index.en-us_files/method_2.png', error = FALSE)
```
</br>
</br>
```{r method_3_image, eval = TRUE, echo = FALSE, fig.cap = "Method 3"}
knitr::include_graphics('/post/2021-08-12-bertrand-paradox/index.en-us_files/method_3.png', error = FALSE)
```

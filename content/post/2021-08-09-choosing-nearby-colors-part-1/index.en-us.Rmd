...
author: Tyler
date: '2021-08-09'
slug: nearby_colors_part_1
summary: Attempting to select colors close to a chosen one by sampling colors in a ellipse in the HCL color space.
thumbnailImage: /post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/h_c_plane.jpeg
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/c_l_plane.jpeg', error = FALSE)
```
...
From here down, I'll hide some of the code similar to previous sections to shorten the post. You can click on <span style="color: #C29CB7 ">[texts]</span> to show code if you want to see it.
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/h_l_curve.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/h_c_plane.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/c_tangent_plane_setup.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/c_tangent_plane.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/sphere_info.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/sphere_c_l.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/sphere_h_l.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/sphere_p_c_l.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/sphere_h_c.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/ellipse_info.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/ellipse_c_l.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/ellipse_h_l.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/ellipse_p_c_l.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/ellipse_h_c.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/tilted_ellipse_info.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/tilted_ellipse_c_l.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/tilted_ellipse_h_l.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/tilted_ellipse_p_c_l.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/tilted_ellipse_h_c.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/compare_info.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/outside_edge_info.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/outside_edge_c_l.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/outside_edge_h_l.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/outside_edge_p_c_l.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/outside_edge_h_c.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/inside_edge_info.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/inside_edge_c_l.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/inside_edge_h_l.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/inside_edge_p_c_l.jpeg', error = FALSE)
```
...
knitr::include_graphics('/post/2021-08-09-choosing-nearby-colors-part-1/index.en-us_files/inside_edge_h_c.jpeg', error = FALSE)
```
